...
public class Camion {
	...
	public Camion(Integer idcamion, String marca) {
		super();
		this.idcamion = idcamion;

	}
	public Camion(Integer idcamion, String marca, Integer linea, Double capacidad) {
		this.idcamion = idcamion;
		this.marca = marca;
		this.linea = linea;
		this.capacidad = capacidad;
	}
	public Camion(Integer idcamion, String marca, Double capacidad) {
		super();
		this.idcamion = idcamion;
		this.marca = marca;
		this.capacidad = capacidad;
